% finds Pythagorean triplets with given perimeter
...
for leg1= 1:p % counts through all possible integers for leg 1
    for leg2= 1:p % counts through all possible integers for leg 2
        ...
        if leg1+leg2+hyp==p && rem(hyp,1)==0 && leg1<p/3 && leg1<leg2 && leg2<p/2
                                             % checking if legs add to perimeter 
                                             % and if calculated hypotenuse
                                             % is whole number and that
